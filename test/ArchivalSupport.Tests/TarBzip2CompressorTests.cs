...
/// <summary>
/// Unit tests for TarBzip2Compressor focusing on exception handling and error recovery paths.
/// </summary>
public class TarBzip2CompressorTests : IDisposable
{
    private readonly string _testDirectory;
    private readonly List<string> _tempFiles;

    public TarBzip2CompressorTests()
    {
        _testDirectory = Path.Combine(Path.GetTempPath(), $"bzip2_tests_{Guid.NewGuid():N}");
    ...
    public async Task Compress_WithInvalidOutputPath_ShouldThrowAndCleanup()
    {
        ...
        var invalidPath = Path.Combine("Z:\\nonexistent_directory_12345", "output.tar.bz2");

        // Act & Assert - Tests lines 41-61 (exception handling)
    ...
    public async Task CompressStreaming_WithInvalidOutputPath_ShouldThrowAndCleanup()
    {
        ...
        // Act & Assert - Tests lines 91-111 (exception handling in streaming)
